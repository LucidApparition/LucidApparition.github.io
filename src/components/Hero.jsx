  ...
  return (
    <section className="relative w-full h-screen mx-auto">
      ...
      top-[120px] max-w-7xl mx-auto flex flex-row items-start gap-5`}>
        ...
        <div>
          <h1>Hi, I'm <span className="text-[#915eff]">Jeff</span></h1>
          <p className={`${styles.heroSubText} mt-2 text-whitte-100`}>
            I am a full stack developer <br className="sm:block hidden" />
            who has created user interfaces, web components, and more.
          </p>
        </div>
      </div>
      <ComputersCanvas />

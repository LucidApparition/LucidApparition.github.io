...
const projects = [
  {
    ...
    image: portfolio,
    source_code_link:
      "https://github.com/LucidApparition/LucidApparition.github.io",
  },
  {
    name: "DrinkersApp",
    description:
      "This is a mobile app for ordering alcohol and having it be delivered to your location",
    tags: [
      {
        name: "Android Studio",
        color: "blue-text-gradient",
  ...
  },
  {
    ...
    description:
      "This is my personal sandbox for creating and testing react components",
    tags: [
      {
        name: "React",
        color: "blue-text-gradient",
